...
es_loader_ec2_role = (
    f'arn:aws-cn:iam::{accountid}:role/aes-siem-es-loader-for-ec2')
    ...
    'Statement': [
        {
            ...
            'Resource': [
                (f'arn:aws-cn:logs:{region}:{accountid}:log-group:/aws/aes'
                 f'/domains/{aesdomain}/*'),
                (f'arn:aws-cn:logs:{region}:{accountid}:log-group:/aws/aes'
                 f'/domains/{aesdomain}/*:*')
            ]
    ...
    'Statement': [
        {
            ...
            'Action': ['es:*'],
            'Resource': f'arn:aws-cn:es:{region}:{accountid}:domain/{aesdomain}/*'
        },
        {
            'Effect': 'Allow',
            'Principal': {'AWS': '*'},
