...
Jump to | [Configuring AWS Services(Log Sources)](docs/configure_aws_service.md) | [Changing Configurations of SIEM on OpenSearch Service](docs/configure_siem.md) | [Advanced Deployment](docs/deployment.md) | [Dashboard](docs/dashboard.md)  | [AWS Control Tower Integration](docs/controltower.md) |  [AWS Security Lake Integration](docs/securitylake.md) | [Supported Log Types](docs/suppoted_log_type.md) | [FAQ](docs/faq.md) | [Changelog](CHANGELOG.md) |
...
[AWS Security Lake Integration](./docs/securitylake.md)
...
Upgrade the domain to OpenSearch 2.3, 1.3, 1.2, 1.1, 1.0 or Elasticsearch version 7.10. Some Dashboards assume OpenSearch Service 1.1 or higher, so the recommended version is OpenSearch Service 2.3 with "Enable compatibility mode":
...
1. For "Version to upgrade to", choose [**OpenSearch 2.3**] (Recommended), [**OpenSearch 1.3**], [**OpenSearch 1.2**], [**OpenSearch 1.1**], [**OpenSearch 1.0**] or [**Elasticsearch 7.10**]
